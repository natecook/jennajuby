...
export default class subscribePreview extends React.Component {
  render() {
    ...
    const entrySubscribe = entry.getIn(["data", "subscribe"]);
    const subscribe = entrySubscribe ? entrySubscribe.toJS() : [];
    
    return <div>
      <Jumbotron image={image} title={entry.getIn(["data", "title"])} />
      <div className="bg-off-white pv4">
        <div className="mw7 center ph3 pt4">
          {subscribe.map(({text, heading, imageUrl}, i) =>
